---
title: "Finding Your Prompts: List, Tree, and Search"
...
<Card title="Search for a Specific Prompt">
...
<Check>
  ...
  **Next up**: [Learn how to take these prompts and actually use them in your Python code](/third).
</Check>