...
**Prompt Lockbox is quite easy to install**. Its available on [pypi](https://pypi.org/) index, so all you need is a python package installer \!
...
You can directly install the toolkit using [pip](https://pip.pypa.io/en/stable/installation/) or from our github [prompt-lockbox](https://github.com/ananya868/prompt-lockbox/tree/main).

**Note:** It is advised to **create a new virtual environment** to avoid any unnecessary package conflict.
...
To do this, **we will use CLI for this guide**. Well, you can also use the SDK for these tasks, checkout [SDK](www.google.com). In your project directory, run -
...
Explore features in the toolkit. 

<CardGroup cols={2}>
  <Card title="Introduction" icon="file" href="/essentials/markdown">
    Get a quick introduction for this toolkit.
  </Card>
  <Card title="Features" icon="square-code" href="/essentials/code">
    Get a quick look for the features.
  </Card>
</CardGroup>