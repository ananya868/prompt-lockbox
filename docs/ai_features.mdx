...
<Tabs>
  ...
  <Tab title="Local">
    ...
    **Models**: Checkout the complete list at [ollama library](https://ollama.com/library)
    ...
    <Warning>
      Local models require few additional configuration steps before it can be used. Checkout [Local LLM Configuration](/configure_llm#local-model-configuration-ollama)
    </Warning>
  </Tab>
</Tabs>
